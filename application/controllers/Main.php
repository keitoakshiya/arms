...
class Main extends CI_Controller
{
	...
	public function accounts_receivable_filtered($a)
	{
		...
		if ($this->form_validation->run()) {
			...
			$this->load->view('template/header2', $data);
			$this->load->view(
				'template/container_header_daterange_accounts_receivable',
				$data
			);
	...
	public function unvoid_official_receipt($or_number){
		$this->load->model('or_list_model');
		$res = $this->or_list_model->unvoid_or($or_number);
	}
	public function permavoid_official_receipt($or_number){
		$this->load->model('or_list_model');
		$res = $this->or_list_model->permavoid_or($or_number);
	}
	public function delete_official_receipt($or_number){
		$this->load->model('or_list_model');
